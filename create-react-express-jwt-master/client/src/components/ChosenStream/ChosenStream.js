...
class ChosenStream extends Component {
    ...
    return (
      <div className="chosenTwitchPlayer">
        <iframe
          src={this.state.liveLink ? this.state.liveLink : "https://player.twitch.tv/?channel=summit1g&muted=true&autoplay=false"}
          height="100%"
          width="100%"
          frameBorder="0"
          title="mainTwitch"
